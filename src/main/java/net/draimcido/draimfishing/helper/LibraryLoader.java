...
public final class LibraryLoader {
    ...
    private static final Supplier<URLClassLoaderAccess> URL_INJECTOR = Suppliers.memoize(() -> URLClassLoaderAccess.create((URLClassLoader) Main.instance.getClass().getClassLoader()));
    ...
    private static File getLibFolder(Dependency dependency) {
        File pluginDataFolder = Main.instance.getDataFolder();
