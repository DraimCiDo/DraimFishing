...
import net.draimcido.draimfishing.hook.ItemsAdderItem;
import net.draimcido.draimfishing.hook.MMOItemsHook;
import net.draimcido.draimfishing.hook.MythicItems;
import net.draimcido.draimfishing.hook.OraxenItem;
import net.draimcido.draimfishing.listener.PapiUnregister;
...
public class ItemUtil {
    ...
    public static void saveToFile(ItemStack itemStack, String fileName){
        ...
        File file = new File(Main.instance.getDataFolder(), File.separator + "loots" + File.separator + fileName + ".yml");
